...
\end{tabular}\caption{Secondo tableau. Vertice $\alpha(3,0)$}
}
\label{tab:tab74}
\end{table}
Siamo giunti alla soluzione ottima, essendo $\OL{c_j}>0 \quad\forall j$. Inoltre la variabile artificiale $x^a$ non è più in base. La nuova base e la nuova soluzione sono:
...
$R_2$ & $x_4$ 		& \Sc{3} 	& 0		& 1		& 0 	& 1 	& \Sc{0}& 0 \\
$R_3$ & $x_1$ 		& \Sc{3} 	& 1 	& \tq 	& 0 	& 0 	& \Sc{\muq}& \uq \\
\end{tabular}\caption{Secondo tableau. Vertice $\alpha(3,0)$ e funzione obiettivo $\varphi$.}
}
\label{tab:tab75}
\end{table}
Per applicare il simplesso, dobbiamo fare in modo che:
...
$R_3$ & $x_1$ 		& \Sc{3} 	& 1 	& \tq 	& 0 	& 0 	& \Sc{\muq}& \uq \\
\end{tabular}\caption{Terzo tableau. Vertice $\alpha(3,0)$}
}
\label{tab:tab77}
\end{table}
...
\end{tabular}\caption{Quarto tableau. Vertice $\beta(\frac{3}{4},3)$}
}
\label{tab:tab78}
\end{table}
Siamo giunti alla soluzione ottima, essendo $\OL{c_j}>0 \quad\forall j$. La nuova base e la nuova soluzione sono:
